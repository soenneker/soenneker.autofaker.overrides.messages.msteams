...
Instead, report it privately using this repository�s [GitHub private vulnerability reporting tool](https://github.com/soenneker/soenneker.autofaker.overrides.messages.msteams/security/advisories/new).
